...
export const seedCharacterData = [
  {
    ...
    partnerId: 1,
    partnerLeader: true, 
    currentState: CHARACTER_STATES.MOVING,
    petId: 0,
    id: 0,
    age: 87,
  ...
  },
  {
    ...
    partnerId: 6,
    partnerLeader: true, 
    currentState: CHARACTER_STATES.IN_CITY,
    petId: 2,
    id: 4,
    age: 66,
  ...
  },
  {
    ...
    partnerId: 10,
    partnerLeader: true, 
    currentState: CHARACTER_STATES.IDLING,
    petId: 8,
    id: 8,
    age: 49,
  ...
  },
  {
    ...
    partnerId: 12,
    partnerLeader: true, 
    currentState: CHARACTER_STATES.DERADIATING,
    petId: 11,
    id: 11,
    age: 47,
  ...
  },
  {
    ...
    partnerId: null,
    partnerLeader: true, 
    currentState: CHARACTER_STATES.HARVESTING,
    petId: 13,
    id: 13,
    age: 38,
